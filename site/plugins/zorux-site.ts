...
const LOC = { "en": {
  ...
  nav: {home:"Home",features:"Recursos",docs:"Docs",github:"GitHub",getStarted:"Começar"},
  hero: {badge:"Do zero ao deploy",title:"O framework AI-native<br/>para aplicações multi-plataforma.",subtitle:"Agentes de IA editam um único YAML. Zorux gera API, admin, mobile, desktop, auth, pagamentos, real-time e testes — em todas as plataformas. Token-efficient por design.",start:"Começar",github:"Ver no GitHub",install:"npm install -g zorux"},
  features: {why:"Recursos",title:"Token-efficient. Multi-plataforma. AI-native.",sub:"47 recursos. Feito para humanos e IAs. Um arquivo para governar todos.",auth:"Autenticação",authSub:"Todo método de auth, zero setup.",platform:"Plataforma",platformSub:"Um schema, todos os dispositivos.",data:"Dados & Storage",dataSub:"Bancos, cache, arquivos — resolvido.",devex:"Experiência Dev",devexSub:"Ferramentas que aceleram você.",security:"Segurança & Permissões",securitySub:"Enterprise-grade, built-in.",realtime:"Tempo Real & Eventos",realtimeSub:"Updates ao vivo, sem infraestrutura."},
